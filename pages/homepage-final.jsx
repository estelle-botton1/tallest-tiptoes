...
export default function Homepage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: c.cream, fontFamily: "'Playfair Display', Georgia, serif", color: c.black }}>
      ...
      {/* HONESTY BOX */}
      <section style={{ padding: "0 20px 40px", ...fadeIn(0.4) }}>
        <div style={{ background: c.black, borderRadius: "3px", padding: "36px 24px", textAlign: "center", position: "relative", overflow: "hidden" }}>
          ...
          <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "28px", fontWeight: "400", fontStyle: "italic", color: c.cream, margin: "8px 0 10px" }}>The Honesty Box</h2>
          ...
          <div style={{ display: "inline-block", padding: "10px 28px", border: "1px solid " + c.red, borderRadius: "2px", cursor: "pointer" }}>
            <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "13px", fontWeight: "600", letterSpacing: "1.5px", textTransform: "uppercase", color: c.oldRose }}>SUBMIT</span>
          </div>
        </div>
      </section>
