  ...
  return (
    <div style={{ minHeight: "100vh", background: c.cream, fontFamily: "'Playfair Display', Georgia, serif", color: c.black }}>
      ...
      <div style={{ padding: "32px 20px 60px", maxWidth: "640px", margin: "0 auto" }}>
        ...
        <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "18px", fontWeight: "400", margin: "24px 0 8px" }}>SMS Program</h2>
        ...
        <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "14px", color: c.ink, lineHeight: "1.7", margin: "0 0 16px" }}>You may cancel the SMS service at any time by replying STOP to any message. After you send STOP, you will receive a confirmation message and will no longer receive SMS messages from us.</p>

        <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "18px", fontWeight: "400", margin: "24px 0 8px" }}>Help</h2>
        <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "14px", color: c.ink, lineHeight: "1.7", margin: "0 0 16px" }}>For assistance, reply HELP to any message or contact us at sophia@tallest-tiptoes.com.</p>
